...
print(f'Root keys: {B.root.keys}')
print(f'Keys of Child 1: {B.root.children[0].keys}')
print(f'Keys of Child 2: {B.root.children[1].keys}')
print(f'Keys of Child 3: {B.root.children[2].keys}')


B.delete_leaf_node(B.root.children[0], 1)
# B.delete_leaf_node(B.root.children[0], 1)
